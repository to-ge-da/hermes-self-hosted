...
Official host install (no Cursor): [INSTALL-HERMES.md](../hermes/INSTALL-HERMES.md).  
...
| [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | Upstream | Latest | No native Cursor | Default path in [INSTALL-HERMES.md](../hermes/INSTALL-HERMES.md) |
...
| Tree | How |
|---|---|
| Official install | `hermes update` — see [INSTALL-HERMES.md](../hermes/INSTALL-HERMES.md) |
...
- Official install: [INSTALL-HERMES.md](../hermes/INSTALL-HERMES.md)
- Uninstall: [hermes-uninstall.md](../hermes/hermes-uninstall.md)
