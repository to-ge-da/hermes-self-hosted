...
6. **Install Hermes Agent** — Non-interactive official installer as the `hermes` user (system packages come from bootstrap). See [INSTALL-HERMES.md](hermes/INSTALL-HERMES.md).

## Related

- Deployment targets and limits: [README.md](../README.md)
- Uninstall Hermes Agent: [hermes-uninstall.md](hermes/hermes-uninstall.md)
- Run the dashboard as a background service: [hermes-dashboard-service.md](hermes/hermes-dashboard-service.md)
